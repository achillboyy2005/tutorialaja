...
const config = {
    XBOT: '❉AmpibI❉', 
    instagram: 'https://instagram.com/achillboyy._', 
    nomer: 'wa.me/6281316105119',
    youtube: 'https://m.youtube.com/channel/UC_xZAqE_Vtgv6-JyXFTypvg/featured",
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6281316105119@s.whatsapp.net"] 
